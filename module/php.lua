...
function install_container()
	...
	install_package("php-fpm php-cli php-gd php-curl php-mysql php-sqlite3 php-odbc php-imap php-memcached php-ssh2 php-zip php-xml php-dom php-mbstring php-xdebug")
	return 0
end
